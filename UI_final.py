...
def model1(file_name,path):
    ...
    model = model_final.load_model(os.path.join(os.getcwd(), 'Model', './Final_model.h5'))
...
def audio(b,name2):
    ...
    target = 'C://Users//sriha//Documents//Prashanth//Major ProjectA//utomated-Cricket-Commentary-//Test Trials//'
    language = 'en'
